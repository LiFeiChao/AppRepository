...
//    _lblLength.text=[NSString stringWithFormat:[[I18NControl bundle] localizedStringForKey:@"remainHowManyChat" value:nil table:nil],kMaxTextLength];
    [_btnSend setTitle:[[I18NControl bundle] localizedStringForKey:@"submit" value:nil table:nil] forState:UIControlStateNormal];
...
-(IBAction)submitSuggestion:(id)sender
{
    if(_txtSuggestion.text.length==0){
        [[[iToast makeText:[[I18NControl bundle] localizedStringForKey:@"pleaseInputSuggest" value:nil table:nil]] setGravity:iToastGravityCenter] show];
        return;
    }
